...
class BacktestConfig:
    ...
    min_commission: float = 5.0  # 最低佣�?5�?
    stamp_duty_rate: float = 0.001  # 印花�?0.1%（仅卖出�?
    transfer_fee_rate: float = 0.00001  # 过户�?0.001%
...
class Settings:
    ...
    # 股票�?
    stock_pool: List[str] = field(default_factory=lambda: ["hs300"])  # 沪深300成分�?
